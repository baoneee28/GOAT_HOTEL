...
with open(r"d:\webProject\GOAT_HOTEL\backend\src\main\java\com\hotel\controller\api\RoomTypeApiController.java", "w", encoding="utf-8") as f:
...
with open(r"d:\webProject\GOAT_HOTEL\frontend\src\pages\admin\RoomTypes.jsx", "w", encoding="utf-8") as f:
    f.write(frontend_code)
print("RoomTypes controller and frontend refactored")
